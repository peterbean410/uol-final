"""DAG: Create end-of-day (EOD) tick snapshots via Kubernetes, 2026 backfill.
...
with DAG(
    ...
    dag_id="create_eod_tick_snapshot_2026",
    default_args=default_args,
    description="Create FX end-of-day tick snapshots for the 2026 backfill",
    schedule="0 0 * * *",
    ...
    create_snapshot = KubernetesPodOperator(
        ...
        name="create-eod-tick-snapshot-2026",
        namespace="airflow",
        image=_ECR_IMAGE,
