"""DAG: Create end-of-interval price snapshots (M1, M5, M15) via Kubernetes, 2026 backfill.
...
with DAG(
    ...
    for interval in _INTERVALS:
        ...
        create_snapshot = KubernetesPodOperator(
            ...
            name=f"create-{interval.lower()}-eoi-snapshot-2026",
            namespace="airflow",
            image=_ECR_IMAGE,
