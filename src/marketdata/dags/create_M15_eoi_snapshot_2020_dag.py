...
download task in the download_price_bars DAG, then a KubernetesPodOperator
runs the create-eoi-price-snapshot script.  All interval chains run in
parallel within a single hourly DAG run.
"""
...
with DAG(
    dag_id="create_eoh_snapshot_2020",
