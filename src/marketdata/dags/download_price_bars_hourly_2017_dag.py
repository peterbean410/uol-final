"""DAG: Download price bars (M1, M5, M15) via Kubernetes, 2017 backfill.
...
with DAG(
    ...
    dag_id="download_price_bars_hourly_2017",
    default_args=default_args,
    description="Download FX price bars (M1, M5, M15), 2017 backfill",
    schedule="0 * * * 1-5",
    start_date=datetime(2017, 1, 1),
    catchup=True,
    tags=["marketdata", "pricedata", "bardata", "download", "backfill-2017"],
) as dag:
